...
var itemURI = document.getElementById("mintNFT");
var createItemButton = document.getElementById("mintBtn");
createItemButton.onclick = mint;
var REQUEST_STATUS = ["Pending", "Active", "Cancelled", "Ended", "Defaulted"];
var LENDING_CONTRACT_ADDRESS = '0x67490a4814a5C127B0522b40d2DaEdF6104BdeA6'; //Connecting with Metamask wallet.
...
var nftContractAddress = document.getElementById("nftContractAddress");
var tokenId = document.getElementById("nftTokenId");

approveNFT = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var web3, accounts, instance;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
          ...
          case 3:
            ...
            instance = new web3.eth.Contract(tokenABI, nftContractAddress.value, {
              from: accounts[0]
            });
            _context3.next = 8;
            return instance.methods.approve(LENDING_CONTRACT_ADDRESS, tokenId.value).send({
              from: accounts[0]
  ...
  return function approveNFT() {
    return _ref3.apply(this, arguments);
  };
}();

createLoan = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            instance = new web3.eth.Contract(contractABI, LENDING_CONTRACT_ADDRESS, {
              from: accounts[0]
            });
            _context4.next = 7;
            return instance.methods.createLoan(nftAddress.value, nftId.value, loanAmount.value.toString(), interestAmount.value.toString(), totalTimePeriod.value * 86400, maxTimePeriod.value).send({
              from: accounts[0]
            }).once("receipt", function (receipt) {
              console.log(receipt);
            }).catch(function (err) {
  ...
  return function createLoan() {
    return _ref4.apply(this, arguments);
  };
}();

acceptLoan = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var web3, accounts, instance, sum;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
          ...
          case 3:
            ...
            sum = ethLoanAmount.value.toString();
            _context5.next = 8;
            return instance.methods.acceptLoan(loanID.value).send({
              value: sum,
              from: accounts[0]
            }).once("receipt", function (receipt) {
              console.log(receipt);
  ...
  return function acceptLoan() {
    return _ref5.apply(this, arguments);
  };
}();

endLoan = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            sum = ethLoanAmount1.value * 1 + ethInterestAmount1.value * 1;
            console.log(sum);
            _context6.next = 9;
            return instance.methods.endLoan(loanID1.value).send({
              value: sum.toString(),
              from: accounts[0]
            }).once("receipt", function (receipt) {
              console.log(receipt);
  ...
  return function endLoan() {
    return _ref6.apply(this, arguments);
  };
}();

extendLoan = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            _context7.next = 7;
            return instance.methods.extendLoan(extendLoanId.value).send({
              from: accounts[0]
            }).once("receipt", function (receipt) {
              console.log(receipt);
            }).catch(function (err) {
  ...
  return function extendLoan() {
    return _ref7.apply(this, arguments);
  };
}();

cancelLoan = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 3:
            ...
            _context8.next = 7;
            return instance.methods.cancelLoan(cancelLoanId.value).send({
              from: accounts[0]
            }).once("receipt", function (receipt) {
              console.log(receipt);
            }).catch(function (err) {
  ...
  return function cancelLoan() {
    return _ref8.apply(this, arguments);
  };
}();

var approves = document.getElementById("approveBtn");
approves.onclick = approveNFT;
var nftAddress = document.getElementById("nftContractAddress1");
var nftId = document.getElementById("nftTokenId1");
var loanAmount = document.getElementById("loanAmount");
var interestAmount = document.getElementById("interestAmount");
var totalTimePeriod = document.getElementById("timePeriod");
var maxTimePeriod = document.getElementById("maxTimePeriod");
var create = document.getElementById("createBtn");
create.onclick = createLoan;
var loanID = document.getElementById("loanId");
var ethLoanAmount = document.getElementById("loanAmount1");
var ethInterestAmount = document.getElementById("interestAmount1");
var accept = document.getElementById("acceptBtn");
accept.onclick = acceptLoan;
var extendLoanId = document.getElementById("extendLoanId");
var extend = document.getElementById("extendBtn");
extend.onclick = extendLoan;
var cancelLoanId = document.getElementById("cancelLoanId");
var cancel = document.getElementById("cancelBtn");
cancel.onclick = cancelLoan;
var loanID1 = document.getElementById("loanId2");
var ethLoanAmount1 = document.getElementById("loanAmount2");
var ethInterestAmount1 = document.getElementById("interestAmount2");
